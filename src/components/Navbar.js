    ...
    >
      <Link to='/'>
        <img src={Logo} alt="logo" style={{
          width: '48px', height: '48px', margin: '0 20'
        }} />
      </Link>
      <Stack
        direction='row'
        ...
        alignItems='flex-end'
      >
        <Link to='/' style={{ textDecoration: 'none', color: '#3A1212', borderBottom:'3px solid #FF2625',cursor: 'pointer',userSelect:'none' }}>Home</Link>
